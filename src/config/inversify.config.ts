...
container
  .bind<ScheduleRepository>(ScheduleRepository)
  .toSelf()
  .inSingletonScope();
container
  .bind<ScheduleController>(ScheduleController)
  .toSelf()
  .inSingletonScope();

container.bind<QuizController>(QuizController).toSelf().inSingletonScope();
